...
\section{Single-substrate Control in Michaelis-Menten Kinetics}
...
\section{Pure non-Competitive Inhibition}
...
\section{Competitive Inhibition}
...
\section{Uncompetitive Inhibition}
...
\section{Generalized Inhibition Model}
...
\section{The Monod-Changeux-Jacob model}
...
\begin{eqnarray}
\epsilon_x^v =& V^+ \times \kappa \times \frac{\partial\theta}{\partial x} \times \frac{x}{v} \\
=& V^+ \times \kappa \times \frac{L \frac{\partial g}{\partial x}}{(L+g)^2} \times \frac{x}{v}
\end{eqnarray}

Now, we can calculate that 
\begin{equation}
\frac{\partial g}{\partial x} = \frac{-h}{K_I + x} \times g
\end{equation}

Substituting this form of $\frac{\partial g}{\partial x}$ into the prior equation, we arrive at 
\begin{eqnarray}
\epsilon_x^v =& V^+ \times \kappa \times \frac{g}{L + g} \times \frac{-hx}{K_I + x} \times \frac{L}{L + g} \times \frac{1}{v}
\end{eqnarray}
...
\section{A Trade-off between Enzyme Cost and Flux Control}
