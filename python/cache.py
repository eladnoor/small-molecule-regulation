...
def rebuild_cache():
    ...
    # Calculate the reversiblity index for each reaction in the model
    Th = reaction_thermodynamics()
    thermo_df = Th.get_thermodynamics()
    thermo_df.to_csv(settings.ECOLI_THERMO_CACHE_FNAME)

    return reg_df, thermo_df

if __name__ == '__main__':
    reg_df, thermo_df = rebuild_cache()
