...
BRENDA_ZIP_FNAME = os.path.join(DATA_DIR, 'brenda_query_merge_2016_06_21.zip')
...
BRENDA_INPUT = [{'fname': 'turnover',   'value_col': 'Turnover_Number'},
                ...
                {'fname': 'inhibitors_ps', 'value_col': None},
                {'fname': 'cofactor_ps', 'value_col': None},
                {'fname': 'metal_ps', 'value_col': None}]
