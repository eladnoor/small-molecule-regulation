...
class reaction_thermodynamics(object):
    ...
    def prepare_mappings(self):
        ...
        self.bigg2kegg = met_df.groupby(
            'bigg.metabolite')['KEGG_ID'].min().to_dict()
        self.bigg2ec = b.reaction_df.groupby(
            'bigg.reaction')['EC_number'].first().to_dict()

        self.bigg2subsystem = b.get_reaction_subsystems()
